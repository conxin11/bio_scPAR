...
class Config:
    ...
    summary_dir_fp = os.path.join(base_output_dir, summary_dir, "summary.txt")
    interaction_type_statis_fp = os.path.join(base_output_dir, summary_dir, "interaction_type.txt")
